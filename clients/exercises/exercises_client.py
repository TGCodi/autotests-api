...
class ExercisesClient(APIClient):
    ...
    def get_exercise_api(self, exercises_id: GetExercisesQueryDict) -> Response:
        """
        Метод получения упражнения

        :param exercises_id: Словарь с exerciseId
        :return: Ответ от сервера в виде объекта httpx.Response
        """
    ...
    def update_exercise_api(self, exercises_id: GetExercisesQueryDict, request: UpdateExerciseDict ) -> Response:
        """
    ...
    def delete_exercise_api(self, exercises_id: GetExercisesQueryDict) -> Response:
        """
